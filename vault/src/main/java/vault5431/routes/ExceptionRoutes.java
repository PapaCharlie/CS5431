...
final class ExceptionRoutes extends Routes {
    ...
    protected void routes() {
        exception(SessionExpiredException.class, (e, req, res) -> renderFatalError("Session has expired!", res));


        exception(InvalidTokenException.class, (e, req, res) -> renderFatalError("Session has expired!", res));

        exception(CouldNotParseTokenException.class, (e, req, res) -> renderFatalError("Session has expired!", res));
