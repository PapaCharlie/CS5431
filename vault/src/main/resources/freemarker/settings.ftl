    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" style="padding: 5px;" id="master">
            ...
            <form action="/changepassword" method="post" id="changePasswordForm">
                ...
                <div class="strength" id="digit" style="color:#FF0000;display:none"> Password is not strong! Try
                    including a
                    number.
                </div>
                <div class="strength" id="symbol" style="color:#FF0000;display:none"> Password is not strong! Try
                    including
                    a non-alphanumeric character.
                </div>
                <div class="strength" id="empty" style="color:#FF0000;display:none"> You can't leave this field empty.
                </div>
                <div class="form-group">
                    ...
                    if (data
                        ...
                        if (passwords.length > 0) {
                            reEncryptedPasswords = passwords.map(function (password) {
                                ...
                                newPassword.notes = encrypt(newKey, password.notes);
